...
#         singlet_model = Model(
#             model_name=r"Singlet (Higgs Portal) benchmark points",
#             model_description=r"""
...
#         singlet_model.save()
        ...
        twohdm_josemi_model = Model(
            model_name=r"2HDM benchmark points",
...
""",
        ...
        josemi_set_1 = Scenario(
            scenario_model=twohdm_josemi_model,
            scenario_number=1,
            scenario_name="Set 1",
...
#             point.save()
        ...
        singlet_jonathan_z2_model = Model(
            model_name=r"$Z_2$-symmetric singlet scalar benchmark points",
            model_description=r"""Benchmark points for the SM extended with a scalar singlet with
...
of CosmoTransitions (see https://arxiv.org/abs/1109.4189).""",
        ...
        singletscalars_moritz_model = Model(
            model_name=r"Scalar dark sector benchmark points",
        ...
        darkphoton_moritz_model = Model(
            model_name=r"Dark photon benchmark points",
        ...
        gaugedlepton_madge_model = Model(
            model_name=r"Gauged Lepton Number Model benchmark points",
...
considered.""",
        ...
        gaugedlepton_madge_scenario_A = Scenario(
            scenario_model=gaugedlepton_madge_model,
            scenario_number=1,
        ...
        composite_model = Model(
            model_name=r"Composite Higgs models benchmark points",
...
particle) is either a meson-like or a glueball-like state.""",
        ...
        RS_model = Model(
            model_name=r"Randall-Sundrum model benchmark points",
        ...
        eft_miki_model = Model(
            model_name=r"EFT benchmark points",
...
a modified version of CosmoTransitions (see https://arxiv.org/abs/1109.4189).""",
        ...
        susy_model = Model(
            model_name=r"Some SUSY embeddings",
...
the corresponding references.""",
        ...
        singlet_jonathan_model = Model(
            model_name=r"Singlet scalar benchmark points",
            model_description="""Benchmark points for the SM extended with a general real singlet scalar field, $S$ (supplied by J. Kozaczuk).""",
            model_notes=r"""
$$
...
""",
        ...
        jonathan_set_1 = Scenario(
            scenario_model=singlet_jonathan_model,
            scenario_number=1,
