...
class PowerSpectrumBPL(PowerSpectrum):
    ...
    def f_turb(self):
        ...
        return 27e-6 * (1 / self.v_wall) * self.beta_tilde * (self.T_star / 100) * (self.g_star / 100)**(1/6)
    ...
    def power_spectrum_sw_conservative(self, f: th.FloatOrArr) -> th.FloatOrArr:
        ...
        """
        return min(self.H_star_eta_sh, 1.) * self.power_spectrum_sw(f)
    ...
    def power_spectrum_turb(self, f: th.FloatOrArr) -> th.FloatOrArr:
        ...
        """
        fp = f / self.f_turb()
        return 3.35e-4 / self.beta_tilde \
